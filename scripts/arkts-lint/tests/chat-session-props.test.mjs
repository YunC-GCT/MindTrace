...
test('conversation header and session list receive reactive parent state', () => {
  ...
  assert.match(parent, /@State @Watch\('onActiveSessionChange'\) activeSid: string/);
